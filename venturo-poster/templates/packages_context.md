# Venturo Service Packages — Context for Poster Generation

Use this reference to enrich AI image prompts. Match the user's chosen tier with the mapped visual themes.
...
Use these to enrich AI image prompts based on the user's chosen tier.
